        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li class="active">
                        <a href="#"><i class="material-icons">content_copy</i><span>Contributions</span></a>
                    </li>
                    <li class="">
            ...
            <div id="content">
                ...
                <div class="main-content">
                    <div class="row">
                        ...
                        <h6> <a type="button" class="btn btn-pink text-dark btn-lg" data-bs-toggle="modal" data-bs-target="#myModal">Add Donation</a></h6>
                    </div>
                </div>
                <div class="row">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>  
                                                <a href="#">
                                                    <div class="btn btn-pink text-dark">Add Payment</div>
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row mb-3">
                                                <div class="col-lg-12">
                                                    <label for="name" class="form-label">Donator Name</label>
                                                    <input type="text" class="form-control" placeholder="Donator Name"aria-label="First name" id="name">
                                                </div>
                                            </div>
